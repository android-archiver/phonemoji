...
internal object TtsSpanHelper {
  ...
  fun addTtsSpan(phoneNumberUtil: PhoneNumberUtil, s: Spannable, start: Int, endExclusive: Int) = s.setSpan(
    createTtsSpan(phoneNumberUtil, s.subSequence(start, endExclusive).toString()),
    start,
    endExclusive,
    Spannable.SPAN_EXCLUSIVE_EXCLUSIVE
  )

  private fun createTtsSpan(phoneNumberUtil: PhoneNumberUtil, phoneNumberString: String): TtsSpan {
